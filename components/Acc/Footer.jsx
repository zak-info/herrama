            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-2  sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
                    <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                        ...
                        <div className='flex items-center gap-2 text-primary-1 text-3xl font-bold'>
                            {/* <Image src={"/logo.png"} width={100} height={100} className='w-20 h-24 rounded-full ' /> */}
                            <span className='text-green-400'>Herrama</span>
                        </div>
                        ...
                        <a href="#" className="py-2.5 px-5 h-9 block w-fit bg-white  transition-all ease-in-out duration-150 rounded-full shadow-sm text-xs text-green-400  mx-auto  hover:bg-white text-primary-1-hover border border-green-400 lg:mx-0">
                            Contact us
                        </a>
                    </div>
                    <div className="lg:mx-auto text-left ">
                        ...
                        <ul className="text-sm  transition-all duration-500">
                            <li className="mb-6"><a href="#home" className="text-gray-600 hover:text-gray-900">Home</a></li>
                            <li className="mb-6"><a href="#about" className=" text-gray-600 hover:text-gray-900">About</a></li>
                            <li className="mb-6"><a href="#pricing" className=" text-gray-600 hover:text-gray-900">Pricing</a></li>
                ...
                <div className="py-7 border-t border-gray-200">
                    <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                        ...
                        <div className="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
                            <a href="javascript:;" className="w-9 h-9 rounded-full bg-secondry-1 flex justify-center items-center bg-primary-1-hover text-primary-1 hover:text-green-400   transition-all ease-in-out duration-150">
