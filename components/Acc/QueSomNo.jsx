...
const QueSomNo = () => {
    return (
        <div className='w-full lg:min-h-[478px] bg-white flex flex-col lg:flex-row items-center md:px-[177px]  md:py-[75px] gap-6 '>
            ...
            <div className=' flex flex-col items-center lg:items-start w-full lg:w-1/2'>
                ...
                <p className='w-3/4 lg:w-full text-[16px] md:text-[20px] text-neutral-500 mt-6'>Située à Thémis, Khemis Khechna, Herrama Cosmetics vous ouvre ses portes dans un espace moderne et accueillant. Nous croyons que chaque visite doit être une expérience agréable et mémorable.</p>
            </div>
